      ...
      <div className="flex flex-col bg-blue-main w-full flex-1 md:flex-none md:w-[40%] md:max-w-[600px] text-white px-8 py-3">
        ...
        <div className="flex flex-col gap-3 text-xs flex-1 justify-center">
          ...
          <div className="flex flex-row gap-2 items-center">
              <input className="checked:fill-green-500" type="checkbox" name="" id="remember" />
              <label htmlFor="remember">Remember Me</label>
          </div>
          <div className="flex w-full justify-center mt-3">
            <Link href={'/admin/home'}><button className="bg-white px-12 py-2 text-primary rounded-[17px]">Sign In</button></Link>
          </div>
          <span className="text-center mt-4">Or Sign Up with :</span>
          <div className="flex flex-row flex-wrap justify-center gap-6">
              <button className="bg-white rounded-[10px] py-2 px-4">
                <FaFingerprint className="fill-primary h-[20px] w-[20px]" />
              </button>
              <button className="bg-white rounded-[10px] py-2 px-4">
        ...
        <div className="px-6 py-3 text-xs text-center">powered by @diprojectin.tech</div>
      </div>
    </div>
  );
}
